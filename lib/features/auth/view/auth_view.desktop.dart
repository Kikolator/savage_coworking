...
class AuthViewDesktop extends ConsumerStatefulWidget {
  const AuthViewDesktop({super.key});

  @override
  ConsumerState<AuthViewDesktop> createState() => _AuthViewDesktopState();
}

class _AuthViewDesktopState extends ConsumerState<AuthViewDesktop> {
