...
class AuthViewPhone extends ConsumerStatefulWidget {
  const AuthViewPhone({super.key});

  @override
  ConsumerState<AuthViewPhone> createState() => _AuthViewPhoneState();
}

class _AuthViewPhoneState extends ConsumerState<AuthViewPhone> {
